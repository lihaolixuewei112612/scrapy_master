...
driver.get('https://red.library.sh.cn/searchInstance')
time.sleep(2)
movie_list = []
for i in range(0, 20):
    c_title=driver.find_elements(By.XPATH, '//div[@class="book"]')
    # print(c_title)
    for i,goods in enumerate(c_title):
        c_title = driver.find_elements(By.XPATH, '//div[@class="tit_right"]')[0]
        ...
        driver.find_elements(By.XPATH, '//div[@class="el-pagination"]/button').click
